...
String help = "Available Command:\n"
                 ...
                 "p: Ping\n"
                 "r: Reset Modul Akselerometer";
MMA7455 Accelerometer = MMA7455();
char NewDataToTransmit[10];
...
void loop()
{
  ...
  if (isTransmissionOn) {
    sprintf(NewDataToTransmit,"%4d%4d%4d\n",Accelerometer.ReadXAxis()
                ,Accelerometer.ReadYAxis(),Accelerometer.ReadZAxis());
    Serial.print(NewDataToTransmit);
  }
